...
">
                        <div class="ax-search__input">
                            <input type="text" placeholder="Enter URL" name="ax-url" id="ax-url" disabled="">
                            <span class="ax-input-number">Page URL <span style="font-weight: 400">(Optional)</span>
</span>
                        </div>

                        <div class="ax-search__btn-wrap">
                            <button href="#" class="ax-btn ax-btn--red" disabled="">
                                Search
                            </button>
                        </div>
                    </div>
...
">Page URL
    ...
    /* font-weight: bold; */
    /* color: black; */
                                                      ">04-27-20 <span style="display:block">05-2-20</span></th>
...
">Deviation
                                ...
                                <tr>
                                    ...
                                    <td class="days" data-th="+19"><span class="bt-content">25</span></td>
                                    <td class="days" data-th="+20"><span class="bt-content">25</span></td>
...
">+ 25</span></td>
                                    <td class="days" data-th="+25"><span class="bt-content" style="
...
">25</span></td>
                                    ...
                                    <td class="deviation" data-th="Deviation from Position #1"><span class="bt-content">-</span>
                                    </td>
                                    <td class="deviation" data-th="Deviation from Position #1"><span class="bt-content">-</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="days" data-th="+20"><span class="bt-content">15</span></td>
                                    <td class="days" data-th="+22"><span class="bt-content">15</span></td>
                                    <td class="days" data-th="+25"><span class="bt-content">15</span></td>

                                    <td class="deviation" data-th="Deviation from Position #1"><span class="bt-content">10</span>
                                    </td>
                                    <td class="deviation" data-th="Deviation from Position #1"><span class="bt-content">10</span>
                                    </td>
                                </tr>
...
">www.progressive.com/car-insurance/</a></span></td>
                                    ...
                                    <td class="days" data-th="+20"><span class="bt-content">10</span></td>
                                    <td class="days" data-th="+22"><span class="bt-content">10</span></td>
                                    <td class="days" data-th="+25"><span class="bt-content">10</span></td>
                                    <td class="deviation" data-th="Deviation from Position #1"><span class="bt-content">15</span>
                                    </td>
                                </tr>
                                </tbody>
