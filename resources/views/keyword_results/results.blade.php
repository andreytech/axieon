@extends('keyword_results.search')
            ...
            <section id="ax-collps">
                <div class="ax-colps ax-colps--blue">
                    ...
                    <div class="collapse ax-colps__body show" id="backlink-insights">
                        ...
                        @include('keyword_results.filters', [])
...
{{--                        @include('chart', array('backlinks' => []));--}}
                        ...
                        @include('keyword_results.backlink_comparison', ['backlinks' => []])
...
">3. Individual Backlink Analysis</h3>
                        ...
                        <div class="your_page_backlinks backlinks_list">
                            @if($your_page_id)
                                @if(count($your_page_backlinks))
                                    @include('keyword_results.individual_backlinks', ['backlinks' => $your_page_backlinks])
                                @else
                        ...
                        <div class="first_page_backlinks backlinks_list">
                            @if(count($first_position_backlinks))
                                @include('keyword_results.individual_backlinks', ['backlinks' => $first_position_backlinks])
                            @else
...
">Our interal filtering mechanism removed <span style="font-weight: bold">583</span> backlinks from this page that were
                        ...
                        @include('keyword_results.anchor_text_usage', ['backlinks' => []])
                        @include('keyword_results.discover_publishers', ['backlinks' => []])
